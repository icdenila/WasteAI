...
# This function manually loads images using PIL, converts them to RGB, and creates arrays.
# This bypasses the TensorFlow "DecodeImage" crash entirely.
    ...
    for label_idx, class_name in enumerate(class_names):
        ...
        for filename in os.listdir(class_dir):
            ...
            try:
                ...
                # Convert to RGB (Fixes Grayscale, CMYK, RGBA issues automatically)
                img = img.convert('RGB')
                # Resize
...
# --- 9. SAVE ---
model.save("waste_efficientnet_3class.keras")
print("Model saved as waste_efficientnet_3class.keras")
